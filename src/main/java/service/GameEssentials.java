...
//                        System.out.println("inside");
                ...
                if(count == coords.size()){
                    if(j>0) {
                        node = new BoardBlock(i * gridWidth, j * gridHeight, gridWidth, gridHeight, i, j,Color.LIGHTBLUE);
                    }
                    else{
                        node = new BoardBlock(i * gridWidth, j * gridHeight, gridWidth, gridHeight, i, j,Color.GREEN);
                    }
                }
